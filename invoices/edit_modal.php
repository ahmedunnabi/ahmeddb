<div class="modal fade" id="edit<?php echo $urow['ID']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<?php
		$n=mysqli_query($conn,"select I.*, P.pBrand from salesorder_13106 I, product_13106 P where ID='".$urow['ID']."' AND I.pCode = P.pCode");
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
		...
		<div class="modal-body">
			PRODUCT: <input type="text" value="<?php echo $nrow['pBrand']; ?>" class="form-control" readonly>
